...
// EXS 20th July 2020 - commented this section out to allow the console to be less cluttered
// while bug hunting the login and signup issues
...
function MediaContent () {
  return (
    ...
    //           <nav className='level is-mobile'>
    //             <div className='level-left'>
    //               <a href='true' className='level-item'>
    //                 <span className='icon is-small' style={styles.iconItem}>
    //                   <i className='fas fa-reply'></i>
    //                 </span>
    //               </a>
